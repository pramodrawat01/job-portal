...
function App() {
  ...
  return (
    <div className="bg-gradient-to-t from-green-100 via-green-50 to-white text-gray-800">
      <ToastContainer />

      {hideNavbar ? <Navbar /> : <UserNavbar />}
